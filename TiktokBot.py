...
print(pyfiglet.figlet_format("Viewbot By xxqk#0001 and ultrasli#1616", font="slant"))

vidUrl = input("By xxqk#0001 and ultrasli#1616 TikTok video URL: ")
...
def methodHearts():
    ...
    print("[+] Hearts sended! by xxqk#0001 and ultrasli#1616")
...
def methodShare():
    ...
    print("[+] Shares sended! by xxqk#0001 and ultrasli#1616")
...
def methodComments():
    ...
    print("[+] Comments Hearts sended by xxqk#0001 and ultrasli#1616!")
